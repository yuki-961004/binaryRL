...
result <- dplyr::bind_rows(binaryRL_res)
...
Using the `comparison.csv` file generated by `binaryRL::fit_p`, you can compare models and select the best one.
