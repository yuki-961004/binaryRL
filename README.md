...
Check the Example Result: [result_comparison.csv](./tests/OUTPUT/result_comparison.csv)
...
<!---------------------------------------------------------->
### Visualizing Model Comparison [[Example Code]](./tests/CODE/test_2_fit_p.Rmd)

<p align="center">
    <img src="./tests/FIGURE/model_comparison(abs).png" alt="RL Models" width="45%" style="display: inline;">
    <img src="./tests/FIGURE/model_comparison(rel).png" alt="RL Models" width="45%" style="display: inline;">
</p>
...
### Visualizing Experimental Effect [[Example Code]](./tests/CODE/test_2.5_rev_e.Rmd)

<p align="center">
    <img src="./tests/FIGURE/Exp_Effect(Frame).png" alt="RL Models" width="45%" style="display: inline;">
    <img src="./tests/FIGURE/Exp_Effect(Block).png" alt="RL Models" width="45%" style="display: inline;">
</p>
...
Check the Example Result: [result_recovery.csv](./tests/OUTPUT/result_recovery.csv)
...
### Parameter Recovery [[Example Code]](./tests/CODE/test_3_rcv_d.Rmd) 
...
<p align="center">
    <img src="./tests/FIGURE/param_rcv/lower_0/1_TD_eta.png" alt="RL Models" width="45%" style="display: inline;">
    <img src="./tests/FIGURE/param_rcv/lower_0/1_TD_tau.png" alt="RL Models" width="45%" style="display: inline;">
</p>
...
<p align="center">
    <img src="./tests/FIGURE/param_rcv/lower_1/1_TD_eta.png" alt="RL Models" width="45%" style="display: inline;">
    <img src="./tests/FIGURE/param_rcv/lower_1/1_TD_tau.png" alt="RL Models" width="45%" style="display: inline;">
</p>
...
### Model Recovery [[Example Code]](./tests/CODE/test_3_rcv_d.Rmd)  
...
<p align="center">
    <img src="./tests/FIGURE/model_rcv/lower_0/matrix_confusion.png" alt="RL Models" width="45%" style="display: inline;">
    <img src="./tests/FIGURE/model_rcv/lower_0/matrix_inversion.png" alt="RL Models" width="45%" style="display: inline;">
</p>
...
<p align="center">
    <img src="./tests/FIGURE/model_rcv/lower_1/matrix_confusion.png" alt="RL Models" width="45%" style="display: inline;">
    <img src="./tests/FIGURE/model_rcv/lower_1/matrix_inversion.png" alt="RL Models" width="45%" style="display: inline;">
</p>
<!---------------------------------------------------------->
