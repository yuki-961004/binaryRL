# binaryRL <img src="./fig/logo.png" align="right" width="120"/>
...
* [Step 1](#1-run-model): Build Reinforcement Learning Models `run_m`
* [Step 2](#2-parameter-and-model-recovery): Parameter and Model Recovery `rcv_d`
* [Step 3](#3-fit-real-data): Fit Real Data `fit_p`
* [Step 4](#4-replay-the-experiment): Replay the Experiment `rpl_e` 
