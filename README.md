...
<!---------------------------------------------------------->
### Visualizing Experimental Effect [[Example Code]](./test/CODE/fit_p.Rmd) 
<p align="center">
    <img src="./test/FIGURE/Exp_Effect.png" alt="RL Models" width="70%">
</p>

<!---------------------------------------------------------->
### Visualizing Model Comparison [[Example Code]](./test/CODE/fit_p.Rmd) 
...
### Parameter Recovery [[Example Code]](./test/CODE/rcv_d.Rmd) 
...
### Model Recovery [[Example Code]](./test/CODE/rcv_d.Rmd) 
