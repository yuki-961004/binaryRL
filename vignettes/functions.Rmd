...
$$
The lapse rate prevents the log-likelihood calculation (`log(P)`) from returning `log(P) -> log(0) -> -Inf`. The default value is set to `lapse = 0.02`, which, in TAFC tasks, means that each option has at least a 1% probability of being selected.  
