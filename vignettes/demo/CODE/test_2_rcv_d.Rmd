...
write.csv(result, file = "../OUTPUT/result_recovery_0.csv", row.names = FALSE)
```
...
<p align="center">
  <img src="../FIGURE/tau_0/1_TD_eta.png" alt="TD_eta" width="30%" style="display: inline;">
  <img src="../FIGURE/tau_0/3_Utility_eta.png" alt="Utility_eta" width="30%" style="display: inline;">
</p>

<p align="center">
  <img src="../FIGURE/tau_0/2_RSTD_eta1.png" alt="RSTD_eta1" width="30%" style="display: inline;">
  <img src="../FIGURE/tau_0/2_RSTD_eta2.png" alt="RSTD_eta2" width="30%" style="display: inline;">
</p>
...
<p align="center">
  <img src="../FIGURE/tau_0/3_Utility_gamma.png" alt="RL Models" width="30%" style="display: inline;">
</p>
...
<p align="center">
  <img src="../FIGURE/tau_0/1_TD_tau.png" alt="TD_tau" width="30%" style="display: inline;">
  <img src="../FIGURE/tau_0/2_RSTD_tau.png" alt="RSTD_tau" width="30%" style="display: inline;">
  <img src="../FIGURE/tau_0/3_Utility_tau.png" alt="Utility_tau" width="30%" style="display: inline;">
</p>
...
<p align="center">
    <img src="../FIGURE/tau_0/matrix_confusion.png" alt="confusion_matrix" width="45%" style="display: inline;">
    <img src="../FIGURE/tau_0/matrix_inversion.png" alt="inversion_matrix" width="45%" style="display: inline;">
</p>
...
recovery <- binaryRL::rcv_d(
  ...
  rfun = list(
    list(
      ...
      tau = function() { stats::rexp(n = 1, rate = 1) + 1 }
    ),
    list(
  ...
  fit_models = list(binaryRL::TD, binaryRL::RSTD, binaryRL::Utility),
  lower = list(c(0, 1), c(0, 0, 1), c(0, 0, 1)),
  upper = list(c(1, 6), c(1, 1, 6), c(1, 1, 6)),
  iteration_s = 100,
  iteration_f = 100,
  nc = 1,
  algorithm = c("NLOPT_GN_MLSL", "NLOPT_LN_BOBYQA")
...
write.csv(result, file = "../OUTPUT/result_recovery_1.csv", row.names = FALSE)
```
...
<p align="center">
  <img src="../FIGURE/tau_1/1_TD_eta.png" alt="TD_eta" width="30%" style="display: inline;">
  <img src="../FIGURE/tau_1/3_Utility_eta.png" alt="Utility_eta" width="30%" style="display: inline;">
</p>

<p align="center">
  <img src="../FIGURE/tau_1/2_RSTD_eta1.png" alt="RSTD_eta1" width="30%" style="display: inline;">
  <img src="../FIGURE/tau_1/2_RSTD_eta2.png" alt="RSTD_eta2" width="30%" style="display: inline;">
</p>
...
<p align="center">
  <img src="../FIGURE/tau_1/3_Utility_gamma.png" alt="RL Models" width="30%" style="display: inline;">
</p>
...
<p align="center">
  <img src="../FIGURE/tau_1/1_TD_tau.png" alt="TD_tau" width="30%" style="display: inline;">
  <img src="../FIGURE/tau_1/2_RSTD_tau.png" alt="RSTD_tau" width="30%" style="display: inline;">
  <img src="../FIGURE/tau_1/3_Utility_tau.png" alt="Utility_tau" width="30%" style="display: inline;">
</p>
...
<p align="center">
    <img src="../FIGURE/tau_1/matrix_confusion.png" alt="confusion_matrix" width="45%" style="display: inline;">
    <img src="../FIGURE/tau_1/matrix_inversion.png" alt="inversion_matrix" width="45%" style="display: inline;">
</p>