...
write.csv(result, file = "../OUTPUT/result_recovery_on.csv", row.names = FALSE)
```
...
#| 
plot_param_rcv(
  data = read.csv("../OUTPUT/result_recovery_on.csv"),
  model = "TD",
  param_index = 1,
  param_name = "η",
...
<p align="center">
  <img src="../FIGURE/on-policy/1_TD_eta.png" alt="TD_eta" width="30%" style="display: inline;">
  <img src="../FIGURE/on-policy/3_Utility_eta.png" alt="Utility_eta" width="30%" style="display: inline;">
</p>

<p align="center">
  <img src="../FIGURE/on-policy/2_RSTD_eta1.png" alt="RSTD_eta1" width="30%" style="display: inline;">
  <img src="../FIGURE/on-policy/2_RSTD_eta2.png" alt="RSTD_eta2" width="30%" style="display: inline;">
</p>
...
<p align="center">
  <img src="../FIGURE/on-policy/3_Utility_gamma.png" alt="RL Models" width="30%" style="display: inline;">
</p>
...
<p align="center">
  <img src="../FIGURE/on-policy/1_TD_tau.png" alt="TD_tau" width="30%" style="display: inline;">
  <img src="../FIGURE/on-policy/2_RSTD_tau.png" alt="RSTD_tau" width="30%" style="display: inline;">
  <img src="../FIGURE/on-policy/3_Utility_tau.png" alt="Utility_tau" width="30%" style="display: inline;">
</p>
...
<p align="center">
    <img src="../FIGURE/on-policy/matrix_confusion.png" alt="confusion_matrix" width="45%" style="display: inline;">
    <img src="../FIGURE/on-policy/matrix_inversion.png" alt="inversion_matrix" width="45%" style="display: inline;">
</p>
...
write.csv(result, file = "../OUTPUT/result_recovery_off.csv", row.names = FALSE)
```
...
#| 
plot_param_rcv(
  data = read.csv("../OUTPUT/result_recovery_off.csv"),
  model = "TD",
  param_index = 1,
  param_name = "η",
  filename = "../FIGURE/1_TD_eta.png"
...
<p align="center">
  <img src="../FIGURE/off-policy/1_TD_eta.png" alt="TD_eta" width="30%" style="display: inline;">
  <img src="../FIGURE/off-policy/3_Utility_eta.png" alt="Utility_eta" width="30%" style="display: inline;">
</p>

<p align="center">
  <img src="../FIGURE/off-policy/2_RSTD_eta1.png" alt="RSTD_eta1" width="30%" style="display: inline;">
  <img src="../FIGURE/off-policy/2_RSTD_eta2.png" alt="RSTD_eta2" width="30%" style="display: inline;">
</p>
...
<p align="center">
  <img src="../FIGURE/off-policy/3_Utility_gamma.png" alt="RL Models" width="30%" style="display: inline;">
</p>
...
<p align="center">
  <img src="../FIGURE/off-policy/1_TD_tau.png" alt="TD_tau" width="30%" style="display: inline;">
  <img src="../FIGURE/off-policy/2_RSTD_tau.png" alt="RSTD_tau" width="30%" style="display: inline;">
  <img src="../FIGURE/off-policy/3_Utility_tau.png" alt="Utility_tau" width="30%" style="display: inline;">
</p>
...
<p align="center">
    <img src="../FIGURE/off-policy/matrix_confusion.png" alt="confusion_matrix" width="45%" style="display: inline;">
    <img src="../FIGURE/off-policy/matrix_inversion.png" alt="inversion_matrix" width="45%" style="display: inline;">
</p>