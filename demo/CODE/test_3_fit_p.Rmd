...
write.csv(result, "../OUTPUT/result_comparison(DEoptim).csv", row.names = FALSE)
```
...
<p align="center">
    <img src="../FIGURE/model_comparison(abs).png" alt="RL Models" width="90%" style="display: inline;">
</p>
...
<p align="center">
    <img src="../FIGURE/model_comparison(rel).png" alt="RL Models" width="90%" style="display: inline;">
</p>
