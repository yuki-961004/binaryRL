...
```{r}
Mason_2024_G1 <- Mason_2024 %>%
  dplyr::filter(Exp == 1) %>%
  dplyr::select(-Exp)

summary(Mason_2024_G1)

usethis::use_data(Mason_2024_G1, overwrite = TRUE)

Mason_2024_G2 <- Mason_2024 %>%
  dplyr::filter(Exp == 2) %>%
  dplyr::select(-Exp)

summary(Mason_2024_G2)

usethis::use_data(Mason_2024_G2, overwrite = TRUE)
```
