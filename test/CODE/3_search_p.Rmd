...
best_params <- data.frame(t(ga_result@solution[1, ]), ga_result@fitnessValue)
colnames(best_params) <- c(
  "eta_pos", "eta_neg",
  "tau",
  "Log_L"
)
...
n_params <- ncol(best_params) - 1
n_trials <- 288
Log_Likelihood <- best_params[1,4]
############################## print parameters ################################
cat("Number of parameters (n_params):", n_params, "\n")
cat("Number of trials (n_trials):", n_trials, "\n")
cat("η+:", best_params[1,1], "\n")
cat("η-:", best_params[1,2], "\n")
cat("τ:", best_params[1,3], "\n")
